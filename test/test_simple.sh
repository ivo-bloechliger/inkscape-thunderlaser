...
python $dir/../thunderlaser.py $ids --cut_color=any --cut_group=cut_wood --cut_wood="30,7,18" --smoothness=0.2 --freq1=20 --maxwidth=900 --maxheight=600 --bbox_only=false --dummy=false --device=/tmp/thunderlaser.rd "$svg"
